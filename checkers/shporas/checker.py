...
class Checker(BaseChecker):
    ...
    def put(self, flag_id: str, flag: str, vuln: str):
        ...
        if vuln in '789':
            self.chm.signup(flag, password)
            self.cquit(Status.OK, '', f'{flag}:{password}:_:{shpora_password}')
    ...
    def get(self, flag_id: str, flag: str, vuln: str):
        ...
        if vuln in '123456':
            ...
            assert_eq(username, flag, "Corrupted flag", Status.MUMBLE)
        self.cquit(Status.OK)
...
if __name__ == '__main__':
    ...
    try:
        ...
        cquit(Status.DOWN, "Can't access service: " + str(e), str(e))
